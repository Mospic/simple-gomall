...
const (
	...
	OrderService_MarkOrderUnPaid_FullMethodName = "/order.OrderService/MarkOrderUnPaid"
)
...
func (c *orderServiceClient) MarkOrderUnPaid(ctx context.Context, in *MarkOrderUnPaidReq, opts ...grpc.CallOption) (*MarkOrderUnPaidResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MarkOrderUnPaidResp)
	err := c.cc.Invoke(ctx, OrderService_MarkOrderUnPaid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	MarkOrderUnPaid(context.Context, *MarkOrderUnPaidReq) (*MarkOrderUnPaidResp, error)
...
func (UnimplementedOrderServiceServer) MarkOrderUnPaid(context.Context, *MarkOrderUnPaidReq) (*MarkOrderUnPaidResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarkOrderUnPaid not implemented")
}
...
func _OrderService_MarkOrderUnPaid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkOrderUnPaidReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).MarkOrderUnPaid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_MarkOrderUnPaid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).MarkOrderUnPaid(ctx, req.(*MarkOrderUnPaidReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MarkOrderUnPaid",
			Handler:    _OrderService_MarkOrderUnPaid_Handler,
		},
	},
